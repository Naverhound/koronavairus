              ...
              <div class="card shadow mb-4 row">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="input-group mb-3">
                        ...
                        <input type="number" class="form-control" aria-label="Dollar amount (with dot and two decimal places)" placeholder="1000000">
                      </div>
                    </div>                    
                    <div class="col-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="input-group mb-3">
                        <select class="custom-select" id="wcolor">
                          <option selected>Wine color...</option>
                          <option value="1">Red Wine</option>
                          <option value="2">Pink Wine</option>
                          <option value="3">White Wine</option>
                        </select>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="input-group mb-3">
                        <select class="custom-select" id="wage">
                          <option selected>Wine age...</option>
                          <option value="1">probandoo</option>                        
                        </select>
                      </div>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-6">
                      <div class="input-group">
                        <input type="text" class="form-control" aria-label="Dollar amount (with dot and two decimal places)"placeholder=" Alcohol level : 8, 9.5, 11, etc..">
